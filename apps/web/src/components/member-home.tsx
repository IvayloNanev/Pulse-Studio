  ...
  return <div className="space-y-4 sm:space-y-5">
    ...
    <section className="rounded-3xl border border-white/70 bg-white/55 p-5 shadow-[0_1rem_3rem_rgba(17,17,17,0.05)] backdrop-blur-xl sm:p-6 xl:p-7" aria-labelledby="studio-essentials-title">
      ...
      <div className="flex snap-x gap-3 overflow-x-auto pb-2 md:grid md:grid-cols-3 md:overflow-visible md:pb-0">
        <article className="min-w-[82%] snap-start rounded-3xl border border-black/10 bg-white/72 p-5 backdrop-blur-xl md:min-w-0"><p className="font-mono text-xs uppercase tracking-[0.12em] text-[#8e211c]">Cancellation</p><h3 className="mt-3 text-lg font-semibold">Keep your credit</h3><p className="mt-2 text-sm leading-6 text-black/65">Cancel at least 12 hours before class. Cancelling exactly at the deadline still returns an included credit.</p></article>
        <article className="min-w-[82%] snap-start rounded-3xl border border-black/10 bg-white/72 p-5 backdrop-blur-xl md:min-w-0"><p className="font-mono text-xs uppercase tracking-[0.12em] text-[#8e211c]">Membership pause</p><h3 className="mt-3 text-lg font-semibold">Plan ahead</h3><p className="mt-2 text-sm leading-6 text-black/65">Pause requests need 30 days’ notice, may last 30–90 days, and include a simulated $25 fee when approved.</p></article>
        <article className="min-w-[82%] snap-start rounded-3xl border border-black/10 bg-white/72 p-5 backdrop-blur-xl md:min-w-0"><p className="font-mono text-xs uppercase tracking-[0.12em] text-[#8e211c]">Class credits</p><h3 className="mt-3 text-lg font-semibold">Know what counts</h3><p className="mt-2 text-sm leading-6 text-black/65">Attended classes, no-shows, and late cancellations use credits. Studio cancellations do not.</p></article>
      </div>
    </section>
    </div>
