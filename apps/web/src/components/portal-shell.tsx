...
export function PortalShell({ audience, eyebrow, title, description, links, showHeader = true, children }: PortalShellProps) {
  ...
  return (
    <div className={`min-h-screen bg-[#f7f6f2] text-[#151515] ${isMember ? "pb-20 lg:pb-0" : ""}`}>
      ...
      {isMember ? <div className="platform-gutter border-b border-black/8 bg-white/45 lg:hidden"><div className="mx-auto flex w-full max-w-[90rem] justify-start py-1"><MemberUtilityNavigation /></div></div> : null}
