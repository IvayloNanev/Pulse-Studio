...
export function PulseAssistantChat() {
  ...
  return <>
    <button ref={openerRef} type="button" onClick={() => { if (!requested.current) setLoading(true); setOpen(true); }} aria-label="Open Pulse Assistant" title="Open Pulse Assistant" className="fixed right-[4.25rem] top-[calc(env(safe-area-inset-top)+0.625rem)] z-50 inline-flex size-11 items-center justify-center rounded-full bg-[#c72c25] font-semibold text-white shadow-[0_0.5rem_1.5rem_rgba(99,20,17,0.28)] transition hover:bg-[#a9231e] focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-2 lg:bottom-5 lg:right-5 lg:top-auto lg:size-auto lg:min-h-12 lg:gap-2 lg:px-5 lg:shadow-[0_1rem_2.5rem_rgba(99,20,17,0.32)]"><MessageCircle className="size-5" aria-hidden="true" /><span className="hidden lg:inline">Pulse Assistant</span></button>
