...
const statusStyle = {
  ...
  no_show: { label: "No-show", dot: "bg-[#c72c25]", badge: "border-black/15 bg-[#c72c25]/10 text-[#8e211c]" },
    ...
    <PortalShell audience="member" eyebrow="Activity" title="Your activity" description="Your completed classes and attendance history." links={memberLinks} showHeader={false}>
      ...
      <header className="overflow-hidden rounded-3xl border border-white/60 bg-[linear-gradient(135deg,rgba(255,255,255,0.88),rgba(238,230,220,0.66))] p-4 shadow-[0_1.25rem_3rem_rgba(17,17,17,0.10),inset_0_1px_0_rgba(255,255,255,0.9)] backdrop-blur-2xl sm:p-6">
        <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
          <div><p className="route-eyebrow flex items-center gap-2 text-black/65"><CalendarDays className="size-4 text-[#c72c25]" aria-hidden="true" /> Activity</p><h1 className="route-title mt-2 text-3xl sm:text-4xl">Your studio history</h1><p className="mt-2 text-sm text-black/65">Past classes and attendance outcomes · updated {timeFormatter.format(now)}</p></div>
