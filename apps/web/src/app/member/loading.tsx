export default function MemberLoading() {
  return (
    <main className="min-h-screen bg-[#f7f6f2] pb-24 text-[#151515] lg:pb-0" aria-busy="true" aria-label="Loading member portal">
      ...
      <header className="platform-gutter sticky top-0 z-50 hidden min-h-20 items-center border-b border-black/15 bg-[#f3f0e9] lg:flex">
      ...
      <div className="platform-gutter min-w-0 py-6 lg:py-8"><div className="mx-auto w-full max-w-[90rem]">
