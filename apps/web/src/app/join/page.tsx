        ...
        <div className="max-w-2xl border-t border-black/20 pt-8">
          ...
          {!params.success && !error && (
            <form action={submitMembershipApplication}>
              ...
              <p className="mt-4 text-xs leading-5 text-black/50">Submitting creates a simulated payment method but does not process a real charge or immediately activate a membership. Staff review is required.</p>
            </form>
          )}
